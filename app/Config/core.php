 ...
 */
	Configure::write('Security.salt', 'DYhG9PdkiyJfIxfs2guVoUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76850309607453042496749683645');
...
Configure::write("Terminal.CurrentAgencyId", 32); 