...
$(function() {
    ...
    function fetchActivities() {
        ...
        $.ajax({
            url: "/city_activity/fetchActivity",
            dataType: "json",
            data: params,
    ...
    $('.form-toggle').click(function() {
        prepareModal();
        initUploader('');
        $('.modal form').attr('action', '/city_activity/create');
    ...
    $('body').on('click', '.action-edit', function() {
        ...
        $('.modal form').attr('action', '/city_activity/update');
        $.ajax({
            url: "/city_activity/get",
            dataType: "json",
    ...
    function updateCategories() {
        $.ajax({
            url: "/city_activity/fetchCategories",
            success: function(data) {
    ...
    function initUploader(id) {
        var traditionalUploader = new qq.FineUploader({
            request: {
                endpoint: "/city_activity/uploadPhoto"
            },
            deleteFile: {
                enabled: true,
                endpoint: "/city_activity/deletePhoto",
                params: {
                    id: id
                },
                method: 'POST'
            ...
            session: {
                endpoint: "/city_activity/getSession",
                params: {
                    id: id
                }
            },
